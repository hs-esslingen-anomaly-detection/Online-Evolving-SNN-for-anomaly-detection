...
cdef class PyOeSNN:
    ...
    def __cinit__(self, int Wsize, int NOsize, int NIsize, double TS, double sim, double C,
                  double mod, double errorCorrection, double anomalyFactor, bool random, bool debug):
        self.thisptr = new OeSNN(Wsize, NOsize, NIsize, TS, sim, C, mod, errorCorrection, anomalyFactor, random)
